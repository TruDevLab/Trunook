...
struct TeleprompterTextView: NSViewRepresentable {
    ...
    /// подсказка пустого суфлера: два числа порознь разъехались бы.
    ...
    func makeNSView(context: Context) -> NSScrollView {
        ...
        // где сказано. Подсказка пустого суфлера рисуется поверх средствами
        // SwiftUI и об эти пять точек и споткнулась: курсор вставал на первой
        // букве подсказки, а не перед ней.
        //
