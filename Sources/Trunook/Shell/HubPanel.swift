...
struct HubPanel: View {
    ...
    ///
    /// Пять — с новостями и сайтами: десятая плитка в четырёх колонках дала бы
    /// третий ряд, а он дороже, чем панель шире на восемьдесят точек.
    ...
    ///
    /// С пятой колонкой — 88: «Буфер обмена» ложится с ужатием кегля,
    /// которое у плитки и так разрешено.
