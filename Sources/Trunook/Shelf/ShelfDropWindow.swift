...
/// системы. Подробности с числами — в `README.md`, раздел «Приём
/// перетаскиваемых файлов»; здесь коротко, почему устроено именно так:
///
...
/// - **В покое — шириной ровно с чёлку.** Прозрачность для мыши и приём файлов
///   оказались одним выключателем: окно, пропускающее нажатия, не принимает
///   и файлы. Значит окно приёма нажатия ест, и позволить себе это можно
///   только под самой чёлкой, где меню-бар пуст по устройству железа.
