...
let known = ["powerConnected", "powerDisconnected", "lowBattery", "trackChanged",
             ...
             "welcome", "purr", "shot", "shotDemo", "shotSettings", "shotNotch", "shotMirror", "shotMarks", "clipboard", "clipboardUse", "clipboardDown", "openEvent", "assistant", "ask", "expand", "homeAll", "homeReset", "homePinned", "notePin", "noteChecklist", "critter", "critterEyes", "critterTail", "critterRun", "critterEars", "critterPaw", "critterSleep", "critterYawn", "critterYarn", "critterAngry", "weatherScene", "weatherChange", "weatherSun", "weatherClouds", "weatherFog", "weatherDrizzle", "weatherRain", "weatherSnow", "weatherThunder", "weatherWind",
             "shelf", "ringMenu", "timer", "timerRun", "stopwatchRun", "monitor", "feeds", "feedsSites", "digestRun", "digestSuggest", "digestPill", "watchCheck", "watchProbe", "watchPill", "teleprompter", "teleprompterScroll", "teleprompterPrompt", "caffeine", "caffeineExpire", "caffeineOn", "keyboardLock", "keyboardLockRun", "keyboardLockExpire",
