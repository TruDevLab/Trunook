...
let known = ["powerConnected", "powerDisconnected", "lowBattery", "trackChanged",
             ...
             "capture", "captureOpen", "captureDown", "captureModels", "captureRun", "pasteProbe", "pasteRow", "runslot1", "ollama", "meetingButtons", "meetingHand", "meetingLink", "meetingProbe",
             ...
             "notes", "notesFill", "notesMiss", "calendar", "calendarTimeline", "homeTimeline", "ring", "eventEdit", "eventNew", "eventSeries", "eventNotes", "notesAsk", "noteNew", "noteEdit", "noteSave",
