...
let known = ["powerConnected", "powerDisconnected", "lowBattery", "trackChanged",
             ...
             "welcome", "closeWindows", "screensSleep", "screensWake", "powerSaveOn", "powerSaveOff", "powerSaveAuto", "purr", "shot", "shotDemo", "shotSettings", "shotNotch", "shotMirror", "shotMarks", "clipboard", "clipboardUse", "clipboardDown", "openEvent", "assistant", "ask", "expand", "homeAll", "homeReset", "homePinned", "homeMail", "mailAsk", "mailSnoozeAsk", "notePin", "noteChecklist", "critter", "critterEyes", "critterTail", "critterRun", "critterEars", "critterPaw", "critterSleep", "critterUpside", "critterYarn", "critterAngry", "critterFist", "critterKiss", "critterChase", "critterHunt", "critterCool", "critterSmoke", "critterMouse", "critterBeach", "critterBird", "critterWatch", "critterWinter", "critterKittens", "critterFlowers", "critterTank", "critterEaster", "critterPumpkin", "critterValentine", "critterRibbon", "critterDragon", "critterRocket", "weatherScene", "weatherChange", "weatherHeavySnow", "weatherBlizzard", "weatherSun", "weatherClouds", "weatherFog", "weatherDrizzle", "weatherRain", "weatherSnow", "weatherThunder", "weatherWind",
