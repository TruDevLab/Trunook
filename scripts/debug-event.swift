...
let known = ["powerConnected", "powerDisconnected", "lowBattery", "trackChanged",
             "settings", "meeting", "mailNotice", "musicSkip", "links", "nextTrack", "reminder", "dump", "thingsRaw", "notifications",
             "capture", "captureOpen", "captureDown", "captureModels", "captureRun", "pasteProbe", "pasteRow", "runslot1", "ollama", "meetingButtons", "meetingFour", "meetingApps", "meetingHand", "meetingLink", "meetingProbe",
             "welcome", "closeWindows", "screensSleep", "screensWake", "screenLock", "screenUnlock", "powerSaveOn", "powerSaveOff", "powerSaveAuto", "purr", "shot", "shotDemo", "shotSettings", "shotNotch", "shotMirror", "shotMarks", "clipboard", "clipboardUse", "clipboardDown", "openEvent", "assistant", "ask", "expand", "homeAll", "homeReset", "homePinned", "homeMail", "mailAsk", "trudaybookFeed", "mailSnoozeAsk", "notePin", "noteChecklist", "critter", "critterEyes", "critterTail", "critterRun", "critterEars", "critterPaw", "critterSleep", "critterUpside", "critterYarn", "critterAngry", "critterFist", "critterKiss", "critterChase", "critterHunt", "critterCool", "critterSmoke", "critterMouse", "critterBeach", "critterBird", "critterWatch", "critterWinter", "critterKittens", "critterFlowers", "critterTank", "critterEaster", "critterPumpkin", "critterValentine", "critterRibbon", "critterDragon", "critterRocket", "weatherScene", "weatherChange", "weatherHeavySnow", "weatherBlizzard", "weatherSun", "weatherClouds", "weatherFog", "weatherDrizzle", "weatherRain", "weatherSnow", "weatherThunder", "weatherWind",
             "shelf", "shelfZones", "shelfZip", "shelfUnzip", "shelfShare", "shelfTrash", "windowSlots", "windowLeft", "windowFill", "windowCycle", "countdownNow", "breakRest", "breakWater", "breakStretch", "water", "waterPill", "waterVessel", "ringMenu", "timer", "timerRun", "stopwatchRun", "monitor", "feeds", "feedsSites", "digestRun", "digestSuggest", "digestPill", "watchCheck", "watchProbe", "watchPill", "teleprompter", "teleprompterScroll", "teleprompterPrompt", "caffeine", "caffeineExpire", "caffeineOn", "caffeinePanel", "keyboardLock", "keyboardLockRun", "keyboardLockExpire",
