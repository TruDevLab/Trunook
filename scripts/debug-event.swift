...
let known = ["powerConnected", "powerDisconnected", "lowBattery", "trackChanged",
             ...
             "welcome", "purr", "shot", "shotDemo", "shotSettings", "shotNotch", "shotMarks", "clipboard", "clipboardUse", "clipboardDown", "openEvent", "assistant", "ask", "expand", "homeAll", "homeReset",
             "shelf", "ringMenu", "timer", "timerRun", "stopwatchRun", "monitor", "feeds", "feedsSites", "digestRun", "digestSuggest", "digestPill", "watchCheck", "watchProbe", "watchPill", "teleprompter", "teleprompterScroll", "teleprompterPrompt", "caffeine", "caffeineExpire", "caffeineOn",
